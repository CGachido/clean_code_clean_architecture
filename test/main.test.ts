...
test("Deve criar um com 3 produtos", async function () {
  const input = {
    cpf: "407.302.170-27",
    items: [
...
test("Deve criar um pedido com 3 produtos e com cupom de desconto", async function () {
  const input = {
    cpf: "407.302.170-27",
    coupon: 'VALE20',
    items: [
